...
namespace Laixer.EventBus.Internal
{
    ...
    public sealed class EventHandlerRegistration
    {
        ...
        public static EventHandlerRegistration Register<TEventInterface, TImplementation>()
            => new EventHandlerRegistration(typeof(TEventInterface), typeof(TImplementation));
    }
}
